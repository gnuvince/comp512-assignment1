...
public interface ItemManager {
     ...
     * @param id unused
     * @param itemId location or flight number (flight number is actually an int)
     * @param quantity
     * @param price
     ...
     * @param id unused
     * @param itemId location or flight number to delete
     * @return true if operation succeeded, false otherwise
     * @throws RemoteException
     */
     ...
     * @param id unused
     * @param itemId location or flight number
     * @return number of available items; 0 if itemId does not exist
     * @throws RemoteException
     */
    public int queryItemQuantity(int id, String itemId) 
        throws RemoteException;
     ...
     * @throws RemoteException
     */
    public int queryItemPrice(int id, String itemId) 
        throws RemoteException;
    
    
    /**
     * Make a reservation of itemId for customer.  The reservation is
     * done in both directions:
     * - item is added to customer's list of reservation
